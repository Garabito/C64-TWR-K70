 ...
 * CSCI E-92 Fall 2022, Professor James L. Frankel, Harvard Extension School
 *
 * Written by James L. Frankel (frankel@seas.harvard.edu)
 *
 * Copyright (c) 2022, 2021, 2017, 2015, 2014, 2012 James L. Frankel.
 * All rights reserved.
 *
 * Last updated: 2:35 PM 1-Nov-2022
 */
...
/* Table 4-1 in Chapter 4: Memory Map on labeled pages 199-200 (PDF
   pages 206-207) of the K70 Sub-Family Reference Manual, Rev. 4, Oct
   2015 describes the system memory map.  With the Cortex-M4 core
   (M1), addresses 0x8000_0000 - 0x8fff_ffff are for the DRAM
   controller in write-through mode; addresses 0x7000_0000 -
   0x7fff_ffff are for the DRAM controller in write-back mode*/
